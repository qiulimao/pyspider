...
from weblocust.libs.log import SaveLogHandler, LogFormatter
...
class ProjectManager(object):
    ...
    def build_module(project, env={}):
        ...
        from weblocust.libs import base_handler
        ...
        weblocust_path = os.path.join(os.path.dirname(__file__), "..")
        if weblocust_path not in sys.path:
            sys.path.insert(1, weblocust_path)
